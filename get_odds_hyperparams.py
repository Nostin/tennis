...
# CONFIGURATION
# -------------------------
TABLE_NAME = "xgboost_odds_data_feed"
...
features = [
    ...
    "p1_odds_shape_flat", "p2_odds_shape_flat", "p1_odds_shape_u", "p2_odds_shape_u", "p1_odds_shape_inv_u", "p2_odds_shape_inv_u",
    "p1_odds_shape_mixed", "p2_odds_shape_mixed", "p1_odds_shape_short", "p2_odds_shape_short", "p1_odds_shape_drift", "p2_odds_shape_drift",
    "p1_odds_shape_unknown", "p2_odds_shape_unknown", "p1_odds_shape_strength", "p2_odds_shape_strength", "p1_odds_shortened_fav", "p2_odds_shortened_fav",
...
def tune_xgboost(X_train, y_train, X_val, y_val):
    ...
    print("\n✅ Best hyperparameters saved to 'best_xgboost_odds_params.json'")
    return best_params

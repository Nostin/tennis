...
with engine.begin() as conn:
    ...
    conn.execute(text("""
        ALTER TABLE matched_atp_records
        ADD COLUMN IF NOT EXISTS f_w_tbs_played INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_won INT,
        ADD COLUMN IF NOT EXISTS f_w_tb_win_pct DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_w_tb_rate DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_w_tbs_played_30d INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_won_30d INT,
        ADD COLUMN IF NOT EXISTS f_w_tb_win_pct_30d DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_w_tb_rate_30d DECIMAL(5,2),   
        ADD COLUMN IF NOT EXISTS f_w_tbs_played_hard INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_played_clay INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_played_grass INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_won_hard INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_won_clay INT,
        ADD COLUMN IF NOT EXISTS f_w_tbs_won_grass INT,
        ...
        ADD COLUMN IF NOT EXISTS f_l_tbs_played INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_won INT,
        ADD COLUMN IF NOT EXISTS f_l_tb_win_pct DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_l_tb_rate DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_l_tbs_played_30d INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_won_30d INT,
        ADD COLUMN IF NOT EXISTS f_l_tb_win_pct_30d DECIMAL(5,2),
        ADD COLUMN IF NOT EXISTS f_l_tb_rate_30d DECIMAL(5,2),   
        ADD COLUMN IF NOT EXISTS f_l_tbs_played_hard INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_played_clay INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_played_grass INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_won_hard INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_won_clay INT,
        ADD COLUMN IF NOT EXISTS f_l_tbs_won_grass INT,
